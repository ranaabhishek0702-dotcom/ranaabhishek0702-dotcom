...
const abhishek = {
  ...
  role: "CS & AI Student",
  currentlyLearning: ["Agentic AI", "System Design", "Full Stack Development"],
  buildingWith: ["React", "Node.js", "MongoDB", "Python"],
  askMeAbout: ["Web Dev", "AI/ML", "Data Analysis", "System Design"],
  funFact: "I debug code at 4AM and somehow it always works",
  goal: "To build AI-powered products that make a real difference"
};
```
...
- 🤖 Deep diving into **Agentic AI** and autonomous systems
- 📊 Exploring **EDA** and data storytelling with Python & Matplotlib
...
[![Email](https://img.shields.io/badge/Email-rana.abhishek0702%40gmail.com-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:rana.abhishek0702@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-Rana07-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Rana07)
...
![Footer](https://capsule-render.vercel.app/api?type=waving&color=0:112240,100:0a192f&height=120&section=footer)
